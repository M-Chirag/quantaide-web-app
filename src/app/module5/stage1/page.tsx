  ...
  return (
    <div className='w-full max-w-[1301px] ml-14 mr-14'>
      <div className='flex flex-row max-md:flex-col max-md:gap-50'>
                ...
                <div className='flex flex-col mt-20 text-black max-md:mt-10 max-md:max-w-full'>
                  <div className='flex gap-5 self-start'>
                    ...
                    <div className='flex flex-col grow shrink-0 justify-end px-5 basis-0 w-fit'>
                      <div className='text-xs'>Hypothesis</div>
                  ...
                  <div className='flex flex-col pl-16 mt-11 text-base max-md:pl-5 max-md:mt-10 max-md:max-w-full'>
                    <div className='justify-center px-6 py-6 leading-7 bg-white rounded-lg border border-gray-200 border-solid max-md:px-5 max-md:max-w-full'>
                      Hypothesis statements contain two or more variables that
                      are measurable or potentially measurable and that specify
                    ...
                    <div className='flex gap-5 mt-7 p-4 bg-white rounded-lg border border-gray-200 border-solid max-md:flex-wrap'>
                      ...
                      <div className='gap-0 my-auto text-base font-semibold leading-7 text-black max-md:flex-wrap max-md:max-w-full'>
                        Testable hypotheses predict a relationship between
                        variables (not concepts).
                      </div>
                    </div>
                    <div className='flex flex-col mt-11 text-base max-md:pl-5 max-md:mt-10 max-md:max-w-full'>
                      Hypothesis need to:
                      <div className='flex gap-5 max-md:flex-col mt-4 max-md:gap-0'>
                        ...
                        <div className='flex flex-col ml-5 w-[50%] max-md:ml-0 max-md:w-full'>
                          <div className='flex flex-col grow p-4 w-full text-base font-semibold text-black bg-white rounded border border-gray-200 border-solid max-md:mt-2'>
                            2. Take into account having an effect and not having
                            an effect. It needs to be able to be the null
                            hypothesis and also not the null hypothesis. 
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='flex justify-end'>
                    <Link href={'../module5/stage2'} passHref>
        ...
        <Sidebar moduleNumber={'5'} expandedState={true}>
          <SidebarItem
            number='1'
            text='What is a hypothesis statement?'
            active={true}
            stageNumber={1}
            href='/module5/stage1'
          />
